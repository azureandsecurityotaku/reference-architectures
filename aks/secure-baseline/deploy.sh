...
az deployment group create --resource-group "${RGNAME}" --template-file  "./networking/hub-regionA.json" --name "hub-0002" --parameters \
            location=$RGLOCATION \
            nodepoolSubnetResourceIds="['$USER_NODEPOOL_SUBNET_RESOURCE_ID','$SYSTEM_NODEPOOL_SUBNET_RESOURCE_ID']" \
            keyVaultSubnetsResourceIds="['$USER_NODEPOOL_SUBNET_RESOURCE_ID','$GATEWAY_SUBNET_RESOURCE_ID']" \
...
echo "GATEWAY_SUBNET_RESOURCE_ID=${GATEWAY_SUBNET_RESOURCE_ID}"
echo "GATEWAY_PUBLIC_IP_RESOURCE_ID=${GATEWAY_PUBLIC_IP_RESOURCE_ID}"
...
az deployment group create --resource-group "${RGNAMECLUSTER}" --template-file "cluster-stamp.json" --name "cluster-0001" --parameters \
               ...
               appGatewaySubnetResourceId=$GATEWAY_SUBNET_RESOURCE_ID \
               appGatewayPublicIP=$GATEWAY_PUBLIC_IP_RESOURCE_ID
